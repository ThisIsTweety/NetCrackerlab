...
/*
        Client client = new Client(1,1234,"Ivan Ivanov", "man", LocalDate.of(1986,1,30));
        BaseContract a = new InternetContract(1, LocalDate.of(2017,7,10),LocalDate.of(2020,7,10),1, client,100);
        BaseContract b = new InternetContract(2, LocalDate.of(2017,7,10),LocalDate.of(2020,7,10),1, client,100);
